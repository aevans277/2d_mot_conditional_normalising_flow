...
params_file = './data/compiled/input_data(full).csv'
output_file = './data/compiled/compiled_vectors-0.05.csv'

#params_file = ('./data/compiled/5e7_0.075thresh/input_data.csv')
#output_file = ('./data/compiled/5e7_0.075thresh/compiled_vectors.csv')
